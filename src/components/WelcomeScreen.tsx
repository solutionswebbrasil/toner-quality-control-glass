  ...
  return (
    <div className="relative max-w-6xl mx-auto">
      ...
      <div className="relative z-10">
        ...
        {/* User Info Card */}
        <Card className="mb-6 backdrop-blur-xl bg-white/70 dark:bg-slate-900/70 border-slate-200/50 dark:border-slate-700/50 shadow-xl shadow-slate-900/5 dark:shadow-slate-900/20">
