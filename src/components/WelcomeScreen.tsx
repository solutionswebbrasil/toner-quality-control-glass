      ...
      <div className="relative z-10">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center mb-4">
            <div className="w-16 h-16 rounded-2xl flex items-center justify-center shadow-2xl bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-600 shadow-blue-500/25">
              <Shield className="w-8 h-8 text-white" />
            </div>
          </div>
          
          <h1 className="text-3xl lg:text-4xl font-bold bg-gradient-to-r from-slate-800 via-slate-700 to-slate-600 dark:from-slate-100 dark:via-slate-200 dark:to-slate-300 bg-clip-text text-transparent mb-4">
        ...
        {/* User Info Card */}
        <Card className="backdrop-blur-xl bg-white/70 dark:bg-slate-900/70 border-slate-200/50 dark:border-slate-700/50 shadow-xl shadow-slate-900/5 dark:shadow-slate-900/20 mb-6">
          <CardContent className="p-6">
            <div className="flex flex-col sm:flex-row items-center justify-between mb-4 gap-4">
              ...
              <Badge 
                variant="secondary" 
                className="px-4 py-2 bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400"
              >
