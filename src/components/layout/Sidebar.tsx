...
export const Sidebar: React.FC<SidebarProps> = ({ 
  ...
  return (
    <aside
      className={cn(
        "fixed left-0 top-0 z-50 h-full w-64 bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700 transition-transform duration-300 ease-in-out lg:translate-x-0",
